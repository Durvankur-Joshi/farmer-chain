...
export default function AdminDashboard() {
  ...
  const fetchPending = async () => {
    try {
      // No need to manually get token from localStorage - cookies are sent automatically
 ...
 const approve = async (role, id, addr) => {
    try {
      // No need to manually get token - cookies are sent automatically
      ...
      // Backend approve - cookies are sent automatically
      await axios.post(
  ...
  // Logout
    ...
    try {
      ...
      // Clear any remaining cookies on frontend
